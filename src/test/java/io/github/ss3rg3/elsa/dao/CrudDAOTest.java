...
public class CrudDAOTest {
    ...
    public void indexAndUpdate_idFieldsAreNotPassedToSource_pass() throws ElsaException {
        ...
        // Index the io.github.ss3rg3.elsa.model again and assert that ID hasn't been indexed in _source field, i.e. search returns null
        ...
        // Update the io.github.ss3rg3.elsa.model and assert that ID hasn't been indexed in _source field, i.e. search returns null

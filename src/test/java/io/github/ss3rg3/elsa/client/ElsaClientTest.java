...
public class ElsaClientTest {
    ...
    // If a user tries to retrieve a DAO from the io.github.ss3rg3.elsa.client, it will throw a RuntimeException
...
//    }
    ...
    @Test(expected = IllegalStateException.class)
    // throws RuntimeException because program should break, if io.github.ss3rg3.elsa.client misconfigured

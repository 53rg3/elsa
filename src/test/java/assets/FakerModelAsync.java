...
public class FakerModelAsync implements ElsaModel {
    ...
    public static FakerModelAsync createModelWithRandomData() {
        final FakerModelAsync bulkModel = new FakerModelAsync();

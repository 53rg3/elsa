...
public enum ReindexOptions {
    ...
    public enum ReindexMode {
        /** Attempts to create the index & mappings with the model provided in destination settings. Throws if no model class was provided. */
        CREATE_NEW_INDEX_FROM_MODEL_IN_DESTINATION,

        /** Attempts to update the mappings with the model provided in destination settings.
         * Index must already exist and have compatible mappings for updating, or non at all. Throws if no model class was provided. */
